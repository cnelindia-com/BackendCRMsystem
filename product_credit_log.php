...
if(isset($_GET['delete_id']))
{
	...
	$dlt_Sql = 'DELETE from product_credit_balance where id ='.$delete_id;
	if(mysqli_query($conn,$dlt_Sql)==TRUE)
	{
		$success='Product Credit Balance Log Deleted Successfully.';
	}
}
...
<div id="sc8" class="tabcontent" style="display: block;">
	<a href="product.php" id="sc8_1">Product</a>
    <span>|</span>
   <!-- <a href="#" id="sc8_1">Online User</a>
    <span>|</span>
    <a href="#" id="sc8_1">VIP</a>
    <span>|</span>-->
    <a href="product_credit_log.php" id="sc8_1" class="actives">Credit Balance Log</a>
</div>
 <div class="container" >
  <div class="filternav">
  <?php 
	...
	<h2>Credit Balance Log</h2>
		<form method="post">
            ...
            <div class="form-group">
				...
				<div class="col-md-10">					
					<input type="text" nmae="remarksearch" value=""/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<?php 
					$sqlproductname = "SELECT name from products";
					...
					{		
						...
						{
					?>
					<input type="checkbox" name="viewtype" checked value="<?php echo $row['name'];?>"/>&nbsp;&nbsp;<?php echo $row['name'];?>
					<?php 
						}
					}
					?>
			...
			<div>
				<input type="button" class="btn btn-secondary" name="submit" id="submit" value="Enquiry"/>
    ...
    <div class="resulttable">
        ...
        <table class="table table-hover table-bordered results" id="table2excel" style="width:800px;">
            <thead style="background-color: #ff720b;">
                <tr>
                  <th>No</th>
                  <th class="col-md-3 col-xs-3">Products Name</th>
                  <th class="col-md-3 col-xs-3">Created On</th>
                  <th class="col-md-3 col-xs-3">Created By</th>
            ...
            <tbody>
            	<?php 
				$get_product_credit = mysqli_query($conn,"Select * from product_credit_balance");
				if(mysqli_num_rows($get_product_credit)>0)
				{
					$count =1;
					while($rows = mysqli_fetch_assoc($get_product_credit))
					{						
                    ...
                    <tr>
                      ...
                      <td><?php echo $rows['cash_in'];?></td>
                      <td><?php echo $rows['cash_out'];?></td>
                      <td><?php echo $rows['Remark'];?></td>              
                      <td><a href="?delete_id=<?php echo $rows['id']?>"><i class="fa fa-trash ml-2"></a></td>
                    </tr>
                    <?php
					}
				}
