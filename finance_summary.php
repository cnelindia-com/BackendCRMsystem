...
else if(isset($_POST['stype']) && $_POST['stype']=="Cash In")
{	
	include('config.php');
	$acid= $_POST['depositinaccount'];
	$famount= $_POST['famount'];
...
else if(isset($_POST['stype']) && $_POST['stype']=="Transfer")
{	
	include('config.php');
...
else if(isset($_POST['stype']) && $_POST['stype']=="Other")
{	
	include('config.php');
	$acid= $_POST['ibnkid'];
	$famount= $_POST['famount'];
...
.popupDiv .top span,.popupDiv_hwe .top_hwe,.txpopupDiv .toptx,.popupDivother .topother{
...
<div id="sc8" class="tabcontent" style="display: block;">
    ...
    <span>|</span>
    <a href="finance_summary.php" id="sc8_1" class="actives">Finance Summary</a>
    <span>|</span>
  ...
  <div class="filternav">
    ...
    <?php    
		...
		while($bnk_row= mysqli_fetch_assoc($result1)){
			...
			$total_depos+=$bnk_row['deposit'];
			$total_withdra+= $bnk_row['withdrawal'];
		}
/*	print_r($accid);
	echo $accountid1."dfdfd";*/
    ?>               
    
    <table class="stats_table" border="1" cellpadding="10">
        <tbody><tr>
            <th><span style="color:blue;">Total Deposit</span></th>
            <th><span style="color:red;">Total Withdrawal</span></th>
            <th><span style="color:green;">Total Balance</span></th>
        </tr>
        <tr>        
            <th><span style="color:blue;"><?php echo $total_depos;?></span></th>
            <th><span style="color:red;"><?php echo $total_withdra; ?></span></th>
            <th><span style="color:green;"><?php echo ($total_depos-$total_withdra); ?></span></th>
        </tr>
    </tbody></table>
    <br/>
    <br/>
        ...
        <table class="table table-hover table-bordered results" id="table2excel">
            <thead style="background-color: #ff720b;">
                ...
                <tr>
                  ...
                  <th class="col-md-3 col-xs-3">Total Deposit </th>
                  <th class="col-md-3 col-xs-3">Total Withdrawal </th>
            ...
            <?php
				...
				/*while($bnk_rows1=mysqli_fetch_assoc($result)){			
					$accountid= explode(",", $bnk_rows1['bankaccount_id']);		
					$accid[]= $accountid[0];
				}*/																																												
					...
					$account_result= mysqli_query($conn, "SELECT * FROM `bank_account` WHERE id= ".$bnk_rows['bankaccount_id']);																								
					$account_rows= mysqli_fetch_assoc($account_result);					
			?>
            	<tr>
                  <td><?php echo $bnk; ?></td>
                  ...
                  <td><?php echo number_format($bnk_rows['deposit'], 2, '.', ','); ?></td>
                  <td><?php echo number_format($bnk_rows['withdrawal'], 2, '.', ','); ?></td>
                  <td><?php echo number_format($total_amount, 2, '.', ','); ?></td>
                  <td><?php echo $bnk_rows['date']; ?></td>                  
                  <td style="color:blue;"><?php echo $account_rows['status']; ?></td>                 
                  <td>
                  
					<span style="white-space:nowrap;color:#0055ff;TEXT-DECORATION: underline;">
	...
	<div style="position: absolute; z-index: 100; top: 50%; left: 50%; margin-left: -183px; margin-top: -107px;width:365px;" class="popupDiv">

    	<div class="top">
    	
        	<span><b>Cash In - <?php $account_rows['bank_account_code']; ?> BANK</b></span>
        ...
        <div class="cashInDiv">
        	...
        	<form name="cashin_form" method="get">
        	<table border="0px" class="cashin_hwe">
        		<tbody class="hwepopuparea hideborder">
        			<tr>
			...
			<div style="position: absolute; z-index: 100; top: 50%; left: 50%; margin-left: -183px; margin-top: -107px;width:365px;" class="popupDiv_hwe">

    	<div class="top_hwe">
    	
        	<span style="color: black;"><b>Cash Out - <?php $account_rows['bank_account_code']; ?> BANK</b></span>
    		<a class="closeBtn_hwe" onclick="closeMe_hwe()" style="margin: -3px 5px 0 0;">[X]</a>
        
    	</div>
        
        <div class="cashoutDiv">
        
        	<form name="cashout_form" method="get">
        	<table border="0px">
        		<tbody class="hwepopuparea hideborder">
        			<tr>
        				<th><span>Account Name</span></th>
            ...
            <input type="hidden" name="stype" value="Cash Out">
  			...
  			<div style="position: absolute; z-index: 100; top: 50%; left: 50%; margin-left: -208px; margin-top: -120.5px;width:415px;" class="txpopupDiv">
            
				<div class="toptx">

					<span style="color: black;"><b>Transfer</b></span>
						<a class="closeBtntx" onclick="closeMe_tx();" style="margin: -3px 5px 0 0;">[X]</a>
				</div>

				<div class="cashTxDiv">
					<form id="transferForm" name="transferForm" method="get">               
                    <table>
                    <tbody class="hwepopuparea hideborder">
                    	<tr>
        			...
        			<div style="position: absolute; z-index: 100; top: 50%; left: 50%; margin-left: -162.5px; margin-top: -96px;width:325px;" class="popupDivother">
	
	<div class="topother">
	
		<span style="color: black;"><b>Other</b></span>
		<a class="closeBtnother" onclick="closeMeother();" style="margin: -3px 5px 0 0;">[X]</a>
	
	</div>
	
	<div class="otherDiv">
	
		<form id="otherForm" name="otherForm" method="get">
	...
	<div style="position: absolute; z-index: 100; top: 50%; left: 50%; margin-left: -183px; margin-top: -107px;width:365px;" class="popupDiv">
    	...
    	<div class="top_hwe">
        	...
        	<span style="color: black;"><b>Cash Out - <?php echo $accnt_rows['bank_account_code']; ?> BANK</b></span>
    		<a class="closeBtn_hwe" onclick="closeMe_hwe()" style="margin: -3px 5px 0 0;">[X]</a>
		...
		<table>
            ...
            <tfoot>
            	<tr>
                    ...
                    <td style="background: #DCE9F9;"><?php echo number_format($total_deposit, 2, '.', ',');?></td>
                    <td style="background:#DCE9F9;"><?php echo number_format($total_withdrawal,2, '.', ',');?></td>
...
//		jQuery('.fixed-top').attr('style','position:fixed');
	}
