 ...
 <?php }?>
  ...
  <form class="form-horizontal" method="post">
   ...
   <div class="row">
                  ...
                  <label class="control-label col-sm-1" style="margin-left: 10px;padding-top: unset;"></label>
					<div class="col-sm-12" style="padding-left: 0;">                       
					  <ul style="background: right;border: none;">
						<li><button class="btn-outline-dark tablinks" id="Accountid" onclick="return openDetails(event, 'Account');">Account</button></li>&nbsp;
						<li><button class="btn-outline-dark tablinks" id="Transactionid" onclick="return openDetails(event, 'Transaction');">Transaction</button></li>&nbsp;
						<li><button class="btn-outline-dark tablinks" id="NewTransactionid" onclick="return openDetails(event, 'NewTransaction');"> New Transaction</button></li>&nbsp;
						<li><button class="btn-outline-dark tablinks" id="Bonusid" onclick="return openDetails(event, 'Bonus');">Bonus</button></li>&nbsp;
					  </ul>
                   </div>
                </div>
			</fieldset>
    ...
    <?php }?>
    <div id="Account" class="tabcontentt">
        <div class="row">
          <div class="col-sm-6">
      ...
      <legend style="background:#fff; width: 107px; padding: 4px;">Bank Account</legend>
        ...
        ?>
                <div class="form-group">
					<label class="control-label col-sm-3" style="margin-left: 40px;"><?php echo $getbankname['name'];?></label>
					<div class="col-sm-4" style="display:flex;">
						<input type="radio" name="bank_radio">
						<input type="text" class="form-control" style="margin-left: 10px;" name="bankaccount[<?php echo $keybank;?>][account][]" placeholder="Bank Account No" value="<?php echo $account;?>"> 
						<input type="text" name="bankaccount[<?php echo $keybank;?>][remark][]" class="form-control" placeholder="Remark" value="<?php echo $remark;?>" style="margin-left: 5px;">
						<a href="#" class="remove_field_bank">
							<i class="fa fa-remove blue-color" style="color: red; font-size: 20px;"></i>
						</a>
					</div>
				</div>
        <?php
      ...
      <legend style="background:#fff; width: 63px; padding: 4px;">Remark</legend>
        <div class="form-group">
          ...
          <div class="col-sm-7">
            <textarea rows="4" cols="50" name="remark"><?php if(isset($_POST['remark'])){echo $_POST['remark'];}else{echo $remark1;}?></textarea>
          </div>
        </div>
        </fieldset>
          </div>
    ...
    <?php if(isset($_GET['id'])){?>
        ...
        <div id="Transaction" class="tabcontentt" style="display:none;">
         	<fieldset style="border: solid 1px #a0a0a0; padding: 2px 30px;">
                ...
                <div class="resulttable" style="overflow: scroll;">
                    ...
                    <table class="table table-hover table-bordered results" id="table2excel">
                        ...
                        <tbody>
							...
							$transactionsql.=" ORDER BY transferdate DESC";
							$totalcashin = 0;
							$totalcashout = 0;
        ...
        <div id="NewTransaction" class="tabcontentt" style="display:none;">
        ...
        <div id="Bonus" class="tabcontentt" style="display:none;">
        	<form method="post">
            	<input type="button" class="btn btn-secondary" name="exportreport" value="Export Report"/>
      	<div>
                <fieldset style="border: solid 1px #a0a0a0; padding: 2px 30px;">
...
function openDetails(evt, detail_id)
{
